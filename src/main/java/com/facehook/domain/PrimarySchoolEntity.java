 ...
 */
@Entity
@Table(name = "primarySchool", schema = "facehook", catalog = "")
public class PrimarySchoolEntity {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        PrimarySchoolEntity that = (PrimarySchoolEntity) o;
    ...
    @OneToMany(mappedBy = "primarySchoolByPrimarySch")
