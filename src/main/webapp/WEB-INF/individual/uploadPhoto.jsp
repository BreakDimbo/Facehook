                                        ...
                                        <table border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                ...
                                                <td class="tblInfo"
                                                    ...
                                                    &nbsp;&nbsp;
                                                    <a href="basicInfo.jsp " class="xh"
                                                       style="color: black">基本信息</a>&nbsp;&nbsp;
                                                </td>
                                                <td class="tblInfo">
                                                    &nbsp;&nbsp;
                                                    <a href="contactInfo.jsp" class="xh"
                                                       style="color: black">联系方式</a>&nbsp;&nbsp;
                                                </td>
                                                <td class="tblInfo">
                                                    &nbsp;&nbsp;
                                                    <a href="personalInfo.jsp" class="xh"
                                                ...
                                                <td class="tblInfo">
                                                    &nbsp;&nbsp;
                                                    <a href="myWorkInfo.jsp" class="xh"
                                                       style="color: black">工作信息</a>&nbsp;&nbsp;
                                                </td>
                                                <td class="tblInfo" bgcolor="#6D84B4">
                                                    &nbsp;&nbsp;
                                                    <a href="upload.jsp" class="xh"
                                        ...
                                        <table width="100%" border="0" cellspacing="1"
                                            ...
                                            <tr>
                                                ...
                                                <td valign="top">
                                                    ...
                                                    <br/>
                                                    &nbsp;
                                                    <input type="file" class="wby" name="avatar"/>
                                                    <br/>
                                                    &nbsp;
